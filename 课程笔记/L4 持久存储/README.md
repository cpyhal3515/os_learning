...
<p align="center">
  <img width="35%" src="./picture/image.png">
</p>
...
<p align="center">
  <img width="35%" src="./picture/image-1.png">
</p>
...
<p align="center">
  <img width="35%" src="./picture/image-2.png">
</p>
...
<p align="center">
  <img width="60%" src="./picture/image-3.png">
</p>
...
<p align="center">
  <img width="20%" src="./picture/image-4.png">
</p>
...
<p align="center">
  <img width="50%" src="./picture/image-6.png">
</p>
...
<p align="center">
  <img width="50%" src="./picture/image-7.png">
</p>
...
* 读取磁盘
    * 打开文件后，程序可以执行 `read` 系统调用根据 inode 的值读取对应的数据。每次完成数据读取后需要更新 inode 的值进而读取下一个数据。
    <p align="center">
    <img width="50%" src="./picture/image-8.png">
    </p>
...
<p align="center">
  <img width="50%" src="./picture/image-9.png">
</p>
